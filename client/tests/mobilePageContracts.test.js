...
const structuredOutlineWorkspace = readClientFile("src/pages/novels/components/structured/StructuredOutlineWorkspace.tsx");
const structuredChapterListCard = readClientFile("src/pages/novels/components/structured/StructuredChapterListCard.tsx");
