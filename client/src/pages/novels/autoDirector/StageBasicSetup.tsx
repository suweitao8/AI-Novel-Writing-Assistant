      ...
      <div className="grid gap-x-8 gap-y-6 md:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          {basicForm.estimatedChapterCount <= 60 ? (
            <div className={`rounded-lg bg-sky-50 px-3 py-2 text-xs leading-5 text-sky-900 dark:bg-sky-900/20 dark:text-sky-300 ${AUTO_DIRECTOR_MOBILE_CLASSES.wrapText}`}>
              紧凑全书模式：AI 会在有限篇幅内完成完整结局，必要时最多追加 5 章收尾。
            </div>
          ) : null}
          {hasLargeChapterPlan ? (
            <div className={`rounded-lg bg-amber-50 px-3 py-2 text-xs leading-5 text-amber-900 dark:bg-amber-900/20 dark:text-amber-300 ${AUTO_DIRECTOR_MOBILE_CLASSES.wrapText}`}>
