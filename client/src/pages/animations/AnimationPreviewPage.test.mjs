...
const pageSource = readFileSync(path.join(pageDir, "AnimationPreviewPage.tsx"), "utf8");
const librarySource = readFileSync(path.join(pageDir, "AnimationLibraryPage.tsx"), "utf8");
const routerSource = readFileSync(path.join(pageDir, "..", "..", "router", "index.tsx"), "utf8");
