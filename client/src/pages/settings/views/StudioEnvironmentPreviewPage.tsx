...
export default function StudioEnvironmentPreviewPage() {
  ...
  return (
    <SettingsShell title="HDRI 3D 预览" description="查看通用 HDRI 环境的投影效果，并调整半球直径（5–30 米）。">
      <div className="h-[min(72vh,52rem)] min-h-[38rem] min-w-0" data-hdri-preview-page={presetId}>
        <Drama3DEditorShell
          header={
            <div data-editor-header="primary" className="flex items-center gap-2 rounded-xl border border-border bg-card px-3 py-2 shadow-sm">
              ...
              <h2 className="min-w-0 truncate text-sm font-semibold">{activePreset.label}</h2>
            </div>
          }
          viewport={
