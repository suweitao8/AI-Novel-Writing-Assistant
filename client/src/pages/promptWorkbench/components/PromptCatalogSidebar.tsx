    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          {isChapterWriterPrompt ? (
            <div className="mb-1 inline-flex max-w-full items-center gap-1 rounded-md bg-primary px-1.5 py-0.5 text-[11px] font-medium leading-4 text-primary-foreground">
        ...
        <span className={cn(
          ...
          <span className={cn(
            ...
            prompt.slotSupported ? "bg-primary" : "bg-muted-foreground",
          )} />
  ...
  return (
    <aside className="flex h-full min-h-0 flex-1 flex-col overflow-hidden border-r border-border bg-muted/30">
      <div className="shrink-0 border-b border-border bg-card px-3 py-3">
        ...
        <Button type="button" variant="outline" className="mt-2 h-9 w-full justify-start" onClick={onManagePlatforms}>
          <Layers3 className="mr-2 h-4 w-4 text-primary" />平台写法
        </Button>
      </div>
