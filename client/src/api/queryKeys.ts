export const queryKeys = {
  ...
  storySettingsScene: (novelId: string, sceneId: string) => ["novels", "story-settings", novelId, "scenes", sceneId] as const,
  ...
  settings: {
    ...
    modelCategories: ["settings", "model-categories"] as const,
    ...
    environmentAssets: ["settings", "environment-assets"] as const,
