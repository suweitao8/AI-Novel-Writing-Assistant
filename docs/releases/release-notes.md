...
- 角色外观状态新增「身上状态」勾选：状态编辑里「时代风格」旁边可以直接勾选 血迹、污渍、尘土、泥泞、磨损、破损、伤痕、烟熏，勾上的标签生成该状态图片时如实画在角色身上（如 战斗后勾血迹+伤痕、末世逃亡勾尘土+磨损）；不勾就保持干净整洁。末世废土等时代风格只负责时代氛围和环境破败（废墟、锈蚀、荒芜的场景照常呈现），不再自动把每个角色都弄得又脏又旧；换时代风格重新生成时服装设计仍会按新时代明显改变。
