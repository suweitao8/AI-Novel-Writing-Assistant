...
- [ ] **Step 2: 运行测试确认因字段未实现而失败**
- [ ] **Step 3: 最小实现字段、范围常量和归一化**
- [ ] **Step 4: 运行共享/服务端契约测试确认通过**
...
- [ ] **Step 2: 运行测试确认失败**
- [ ] **Step 3: 添加输入、inline 错误状态和保存归一化**
- [ ] **Step 4: 更新资产卡片展示来源**
- [ ] **Step 5: 运行客户端契约测试与 typecheck**
...
- [ ] **Step 2: 运行测试确认失败**
- [ ] **Step 3: 添加纯解析函数并接入 novel_import blocking actor**
- [ ] **Step 4: 运行 blocking 聚焦测试、服务端 build 和 Prisma generate**
...
- [ ] **Step 1: 更新长期架构规则和用户可见更新**
- [ ] **Step 2: 检查工作区只包含本任务文件**
- [ ] **Step 3: 运行 readme-release-updater 流程、提交并签名**
- [ ] **Step 4: 用 `pnpm workflow:integrate codex/character-state-height-input --verify "<focused checks>" --push` 集成并推送**
