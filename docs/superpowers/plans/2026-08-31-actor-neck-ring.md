...
- Modify: client/src/pages/models/modelLibrary3d/modelMaterials.ts — keep M_Neck from using the default fallback material.
- Modify: client/src/config/modelLibrary.ts — declare the static UAL2 M_Neck tint.
- Modify: client/src/pages/drama/comicDrama/components/blocking3d/__tests__/actorMaterialAsset.test.mjs — assert both real UAL2 resources contain a complete neck partition.
- Modify: client/src/pages/drama/comicDrama/components/blocking3d/__tests__/animationPreviewApp.test.mjs — assert the shared runtime policy exposes and uses the neck role.
...
- Modify: client/src/pages/drama/comicDrama/components/blocking3d/__tests__/actorMaterialAsset.test.mjs

- [ ] **Step 1: Write tests against the required resource result**
...
pnpm exec vitest run client/src/pages/drama/comicDrama/components/blocking3d/__tests__/actorMaterialAsset.test.mjs client/src/pages/drama/comicDrama/components/blocking3d/__tests__/animationPreviewApp.test.mjs
~~~
...
- [ ] **Step 1: Implement parsing and signature validation**
...
- [ ] **Step 2: Implement deterministic neck selection**
...
- [ ] **Step 3: Implement GLB serialization without rewriting animation data**
...
- [ ] **Step 4: Run the new unit/resource tests**
...
- [ ] **Step 1: Create and verify an external backup**
...
- [ ] **Step 2: Generate repaired outputs outside tracked paths**
...
- [ ] **Step 3: Replace only the two validated resources**
...
- [ ] **Step 1: Extend the material-role contract**
...
- [ ] **Step 2: Route neck and joints to the same highlight material**
...
- [ ] **Step 3: Declare static preview tint**
...
- [ ] **Step 4: Run focused TypeScript and policy tests**
...
- [ ] **Step 2: Run the required built-in browser smoke**
...
- [ ] **Step 3: Perform self-acceptance**
