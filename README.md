...
- 模型库大扩容：从 44 个扩充到 510 个常用模型，分类细化为家具、装饰、厨房、电器、卫浴、地面、植物、自然、户外、工具、灯具、背景 12 类；餐厅、办公室、酒吧、洗衣店、家庭住宅等场景的近景道具都有覆盖，漫剧里能摆的道具选择丰富了一个数量级。
- 模型观感全面升级：所有模型补齐从源项目提取的法线贴图，砖石、织物、木纹有了真实的表面起伏细节；预览与 3D 编辑改用棚拍式三点布光和电影级色调映射，模型不再发灰发平。
