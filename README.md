...
### 2026-09-03
- 模型库第五批扩量：新增 95 个废土与街景模型入库，全库达到 495 个精选模型；补齐废弃/末日场景道具（垃圾箱、瓦砾堆、锈桶、军用箱、旧家具、蛛网、旧书堆、破床垫）、后苏联街区生活件（阳台晾衣架、铁笼灯、伏特加瓶）、下水道与街区细节（通风管件、施工锥桶、报刊箱）和野花草丛植被，全部经过尺寸、材质、视觉审核与前景门禁。
