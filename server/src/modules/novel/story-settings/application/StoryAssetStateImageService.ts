...
import { ROOM_ARCHITECTURE_NEGATIVE_PROMPT } from "../../../../services/image/roomArchitecture";
import { buildStateImagePrompt } from "../../../../services/image/storyStateImagePrompt";
import {
...
// 提示词组装已下沉到 services/image/storyStateImagePrompt.ts：场景全景契约（2:1 等距柱状、
// 分区布局、建筑合理性）同时被小说场景状态与通用环境资产生成复用；此处 re-export 保持
// 既有调用方与契约测试（server/tests/storyAssetStateImage.test.js）的导入路径不变。
export { buildStateImagePrompt };
