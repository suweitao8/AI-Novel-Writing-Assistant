...
export const PROVIDERS: Record<BuiltinLLMProvider, ProviderConfig> = {
  ...
  codex: {
    // 2026-08-27 起 codex 桥同时承载图片与文本/视觉：chat completions 走
    // codex exec（默认 gpt-5.5 + low 推理档 = fast 模式），图片仍走 image_generation 工具。
    name: "Codex 订阅",
    baseURL: "http://127.0.0.1:18766/v1",
    defaultModel: "gpt-5.5",
    models: ["gpt-5.5", "gpt-5.4", "gpt-5.4-mini", "gpt-image-2"],
  ...
  indextts25: {
    name: "IndexTTS 2.5 语音",
    baseURL: "http://127.0.0.1:9005",
    defaultModel: "index-tts-2.5",
    models: ["index-tts-2.5"],
    envKey: "INDEXTTS25_API_KEY",
    envBaseURLKey: "INDEXTTS25_BASE_URL",
    envModelKey: "INDEXTTS25_MODEL",
    defaultApiKey: "local-indextts25",
    requiresApiKey: false,
    supportsModelList: false,
  },
};
