ALTER TABLE "DramaCharacter" ADD COLUMN "gender" "CharacterGender" NOT NULL DEFAULT 'unknown';
...
ALTER TABLE "DramaCharacterLibrary" ADD COLUMN "gender" "CharacterGender" NOT NULL DEFAULT 'unknown';
