...
//    写实影视化质感和类别专属禁区。固定规格只进入对应资产图，不进入分镜首帧图。
...
export const DEFAULT_DRAMA_ASSET_STYLES: Record<DramaAssetStyleKind, DramaAssetVisualStyle> = {
  character: {
    ...
    styleInstructions:
      "写实影视化角色资产质感：真实比例与自然人体结构，细腻但不过度磨皮的皮肤、发丝、织物和金属材质，真实光照与自然阴影，克制景深，统一色彩和电影级成片；角色造型、服装与配饰保持完全一致。",
    avoidInstructions:
      "禁止：平面2D动画、卡通、插画、赛璐璐上色、手绘油画风；不要真人摄影、证件照、商品目录；不要人体结构错误、多肢、畸形手、视图之间造型不一致；不要水印、签名或文字。",
    styleTag: "角色资产写实影视化，真实材质与电影级光影",
  },
  scene: {
    kind: "scene",
    label: "场景画风",
    ...
    styleInstructions:
      "写实影视化场景质感：真实空间比例与自然材质，清晰的建筑和环境细节，符合现场逻辑的光照、阴影与大气透视，克制反射，统一色彩和高画质全景成片。",
    avoidInstructions:
      "禁止：平面2D动画、卡通、插画、赛璐璐上色、手绘油画风；不要摄影照片拼接感、低多边形素材感、塑料或蜡质表面、空间断裂、重复接缝、裁切环境；不要水印、签名或文字。",
    styleTag: "场景资产写实影视化，真实环境与空间层次",
  },
  prop: {
    kind: "prop",
    label: "道具画风",
    ...
    styleInstructions:
      "写实影视化道具质感：真实结构与比例，可信的硬表面或软材质细节，清晰结构与磨损层次，自然光照、阴影与克制反射，统一色彩和高画质资产展示成片。",
    avoidInstructions:
      "禁止：平面2D动画、卡通、插画、赛璐璐上色、手绘油画风；不要商品目录或普通产品摄影感、低多边形素材感、塑料或蜡质表面、结构模糊、重复道具、杂乱陈列；不要水印、签名或文字。",
    styleTag: "道具资产写实影视化，真实材质与结构细节",
  },
};
