// 漫剧美术风格：从旧项目（mydrama/supertale）移植的风格预设体系。
...
// 内置预设是全小说通用的起点；小说自有的多套风格（如 现代→末世 切换）存 NovelSettingsWorld.artStylesJson。
...
export const DRAMA_VISUAL_STYLE_PRESETS: DramaVisualStylePreset[] = [
  {
    id: "unreal_cinematic_3d",
    label: "3D写实电影",
    summary: "虚幻引擎级 3D 写实，电影化光影与真实材质（《黑神话：悟空》式质感），全类型小说的默认选择。",
    styleInstructions: "Create a photorealistic AAA game cinematic 3D render with an Unreal Engine 5 look: physically based materials, realistic skin, hair and fabric detail, cinematic volumetric lighting, filmic color grading, shallow depth of field, and an 8K blockbuster finish. Apply this style only to the rendering medium, materials, lighting, and finish; do not infer or change facial features, ages, genders, body proportions, clothing, props, environments, or backgrounds from the style preset. Always follow explicit character descriptions, reference images, and scene descriptions; do not override them with the style preset.",
    avoidInstructions: "FORBIDDEN: flat 2D anime, cartoon, illustration, cel shading, painterly rendering. NOT low-poly game asset, NOT plastic toy texture, NOT wax figure. No over-smoothed skin, no HDR overprocessing, no messy ornament overload. No bad anatomy, extra limbs, or mutated hands. No watermarks, signatures, or text overlays.",
  ...
  },
  {
    id: "guoman_fantasy",
    label: "3D玄幻国漫",
    summary: "高精度 3D 国漫渲染，精致材质与边缘光，仙侠玄幻题材常用。",
  ...
  },
  {
    id: "post_apocalyptic",
    label: "写实末日",
    summary: "真人实拍质感，灰调废土、尘土与锈蚀，末世爆发后的画风。",
  ...
  },
  {
    ...
    label: "民国年代剧",
    summary: "真人实拍质感，民国氛围、旧上海街景与年代配色。",
...
export const DEFAULT_DRAMA_VISUAL_STYLE_ID = "unreal_cinematic_3d";
