...
> = {
  ...
  render: (_input, context) => [
    new SystemMessage([
      ...
      "3. 每个角色都必须输出 gender、actorKind、bodyBuild；gender 允许值只有 male、female、other、unknown，actorKind 允许值只有 human、monster、other、unknown，bodyBuild 允许值只有 slender、standard、broad、unknown。",
      ...
      "7. 每个角色必须输出 personality、background、development、actorKind、bodyBuild 和角色硬事实字段：identityLabel、factionLabel、stanceLabel、powerLevel、realm、currentLocation、availability、prohibitions。",
